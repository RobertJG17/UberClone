...
//  UberClone
//
//  Created by Robert Guerra on 5/18/20.
...
class signUpController: UIViewController {
    ...
    private lazy var accountTypeContainerView: UIView = {
        let view = UIView().inputContainerView(image: #imageLiteral(resourceName: "ic_account_box_white_2x"), segmentedControl: accountTypeSegmentedController)
    ...
    private let fullNameTextField: UITextField = {
        return UITextField().textField(withPlaceholder: "Name (First and Last) ",
                                       isSecureTextEntry: false)
    }()
